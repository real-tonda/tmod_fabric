...
public class SkinManager {
    ...
    public static void applySkin(ServerPlayerEntity player, SkinData skinData) {
        ...
        ((GameProfileAccessor) (Object) profile).getProperties().removeAll("textures");

        // Add new skin properties
        ((GameProfileAccessor) (Object) profile).getProperties().put("textures",
        ...
        fetchUUID(playerName)
                ...
                .thenAccept(skinData -> {
                    if (skinData != null && skinData.isValid()) {
                        ...
                        ((net.minecraft.server.world.ServerWorld) ((com.togun.tmod.mixin.EntityAccessor) player)
                                .getLevelField()).getServer().execute(() -> {
                                    applySkin(player, skinData);
                                });
                    } else {
