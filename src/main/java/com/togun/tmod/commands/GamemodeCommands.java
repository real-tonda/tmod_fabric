...
public class GamemodeCommands {
    ...
    private static int setCreativeOther(CommandContext<ServerCommandSource> context) {
        ...
        source.sendFeedback(() -> Text.literal("Game mode set to Creative for " + targetPlayer.getName().getString() + "."), false);
    ...
    private static int setSurvivalOther(CommandContext<ServerCommandSource> context) {
        ...
        source.sendFeedback(() -> Text.literal("Game mode set to Survival for " + targetPlayer.getName().getString() + "."), false);
    ...
    private static int setAdventureOther(CommandContext<ServerCommandSource> context) {
        ...
        source.sendFeedback(() -> Text.literal("Game mode set to Adventure for " + targetPlayer.getName().getString() + "."), false);
    ...
    private static int setSpectatorOther(CommandContext<ServerCommandSource> context) {
        ...
        source.sendFeedback(() -> Text.literal("Game mode set to Spectator for " + targetPlayer.getName().getString() + "."), false);
